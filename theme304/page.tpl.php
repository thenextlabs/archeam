	...
	<div class="min-width">
                ...
                <div class="head-row3">
                	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                        ...
                        <object data="<?php print base_path().path_to_theme() ?>/flash/header_v8.swf"
                            width="980" height="423" type="application/x-shockwave-flash">
                            <param name="quality" value="high" />
                            <param name="menu" value="false" />
                        ...
                        <div id="cont-col">
                            <div class="ind">
                                ...
                                <?php if ($tabs): print '<div id="tabs-wrapper" class="clear-block">'; endif; ?>
                                	...
                                	<?php if ($title): print '
                                    <h1'. ($tabs ? ' class="with-tabs title"' : '') .'>'. $title .'</h1>
                                	'; endif; ?>
     ...
     <div id="footer">
        <div class="foot">
        	<div class="bot-left">
            	<div class="bot-right">
                        <span>Copyright &copy; <?php print(date('Y'));?>, Archeam</span>
                </div>
            </div>
        </div>
    </div>
